...
print("Generating PyInstaller spec file for Genie GitHooks...")
...
# Write the spec file
with open('genie-githooks.spec', 'w') as f:
    f.write(spec_content)

print("✅ PyInstaller spec file generated: genie-githooks.spec")
